<?php
/*
Este archivo contiene todo lo necesario para que esta aplicacion se conecte con la BBDD personas y puedan realizarse consultas, inserciones, eliminaciones y actualizacion
**/
